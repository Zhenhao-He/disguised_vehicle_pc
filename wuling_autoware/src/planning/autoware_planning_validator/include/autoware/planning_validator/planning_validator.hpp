...
private:
  ...
  autoware::universe_utils::InterProcessPollingSubscriber<std_msgs::msg::Bool> sub_parking_state_{
  ...
  rclcpp::Publisher<RouteState>::SharedPtr pub_planning_status_;
  ...
  std_msgs::msg::Bool::ConstSharedPtr current_parking_state_;
