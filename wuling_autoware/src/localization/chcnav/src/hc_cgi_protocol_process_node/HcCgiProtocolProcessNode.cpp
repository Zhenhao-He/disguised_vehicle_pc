...
int main(int argc, char **argv)
{
    ...
    auto serial_suber = nh->create_subscription<msg_interfaces::msg::HcSentence>("~/input/chcnav/hc_sentence", 1000, hc_sentence_callback);

    gs_devpvt_pub = nh->create_publisher<msg_interfaces::msg::Hcinspvatzcb>("~/output/chcnav/devpvt", 1000);
    gs_devimu_pub = nh->create_publisher<msg_interfaces::msg::Hcrawimub>("~/output/chcnav/devimu", 1000);
